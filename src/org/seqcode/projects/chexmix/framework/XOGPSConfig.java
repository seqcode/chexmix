...
public class XOGPSConfig {
	...
	public XOGPSConfig(GenomeConfig gcon, String[] arguments){this(gcon, arguments, true);}
	public XOGPSConfig(GenomeConfig gcon, String[] arguments, boolean isGPS){
	 ...
	 */
	public void makeXOGPSOutputDirs(boolean makeInterAndImageDirs){
